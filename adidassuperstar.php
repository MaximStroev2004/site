    ...
    <div class="container">
       <header>
        ...
        <div class="product-details">
            ...
            <img src="image/2.png" alt="Adidas Superstar">
            <p class="product-description">Культовая модель кроссовок от Adidas, ставшая иконой уличной моды. Эти кроссовки прославились своим стильным дизайном и высоким уровнем комфорта.</p>
            <p class="product-price">Цена: 7.990 руб</p>
            <form class="add-to-cart-form" action="cart.php" method="post">
                <input type="hidden" name="action" value="add_to_cart">
                <input type="hidden" name="product_id" value="2">
                <button type="submit">Добавить в корзину</button>
            </form>
            <form class="add-to-favorites-form" action="adidas_superstar.php" method="post">

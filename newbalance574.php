    ...
    <div class="container">
       <header>
        ...
        <div class="product-details">
            ...
            <img src="image/5.png" alt="New Balance 574">
            <p class="product-description">Эти кроссовки сочетают в себе классический дизайн с современными технологиями, обеспечивая оптимальную поддержку и амортизацию на протяжении всего дня.</p>
            <p class="product-price">Цена: 22.050 руб</p>
            <form class="add-to-cart-form" action="cart.php" method="post">
                <input type="hidden" name="action" value="add_to_cart">
                <input type="hidden" name="product_id" value="5">
                <button type="submit">Добавить в корзину</button>
            </form>
            <form class="add-to-favorites-form" action="new_balance_574.php" method="post">
